...
function getRankers() {
	...
	$.ajax('/godgamez/user/get/rankers')
		.done(rankers => {
			if(rankers.length) { 
				let rankerList = [];
				...
				$('#rankingBoard').append('<tr><td colspan="6" class="text-center">회원이 없습니다.</td></tr>');
		}).fail(() => {
...
function playerPage(nickname) {
	...
	$.ajax({
        ...
        success: function(target) {
        	if(target != null)
        		location.href="/godgamez/user/playerpage/" + target.usrCode;
...
function questMainBtn() {
	location.href = "/godgamez/quest/board"
}

function couponMainBtn() {
	location.href = "/godgamez/coupon/shop"
}
</script>
				...
				<div class='col d-flex justify-content-end'>
					<div class='card p-0 m-0' onclick='questMainBtn()' title='현생으로 모험을 떠나보자!'>
						<div class='card-body p-0 m-0'>
							<div>
								<video class='card-img-top btn p-0 m-0' autoplay loop muted>
							    	<source src="/godgamez/res/main/main_quest_btn.mp4" type="video/mp4">
								</video>
				...
				<div class='col d-flex justify-content-start'>
					<div class='card p-0 m-0' onclick='couponMainBtn()' title='퀘스트를 깨면 어마어마한 보상이...!'>
						<div class='card-body p-0 m-0'>
							<div>
								<video class='card-img-top btn p-0 m-0' autoplay loop muted>
							    	<source src="/godgamez/res/main/main_reward_btn.mp4" type="video/mp4">
								</video>
