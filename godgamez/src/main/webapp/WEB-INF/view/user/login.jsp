...
$(document).ready(function() {
	if(localStorage.getItem("rememberId") != null) {
		$('#usrId').val(localStorage.getItem("rememberId"));
	}
})
</script>
		...
		<div class='row my-5'>
			<div class='col'>
				...
				<div class='row text-center my-3'>
					<a href='/godgamez/user/account/step1' class='col text-dark'> 아이디 / 비밀번호 찾기 </a>
				</div>
				<hr>
				...
				<div class='row text-center'>
					<a href='/godgamez/user/join/step1' class='col mt-2 text-dark'> 회원 가입하기 </a>
				</div>
			</div>
		</div>
	</div>
