		...
		<div class='row'>
			<div class='col'>
				...
				<div class='row my-4 mx-3 justify-content-around'>
					<a class='btn btn-outline-secondary col mr-1' href='/godgamez/'>메인</a>
					<a class='btn btn-secondary col' href='/godgamez/user/login'>로그인</a>
				</div>
				<hr>
				<div class='row'>
					<div class='col d-flex justify-content-center'>
						<p class='text-center'>
							...
							메일 인증에 대한 내용은 
							<a class='text-dark' href='/godgamez/user/mypage'>MyPage <i class="fas fa-external-link-alt"></i></a>
							에서 확인할 수 있습니다.
						</p>
					</div>
				</div>
