			...
			if(noobs.length) {
				...
				$.each(noobs, (idx, noob) => {
					noobList.push(
						`<tr id='noobDetail'>
							<td class='checkCol'>
								<input type='checkbox' name='check1' class='usrCode' value='\${noob.usrCode}'>
							</td>
				...
				$('#noobUsrCnt').each(function () {
					$(this).prop('Counter',0).animate({
						...
						duration: 800,
						easing: 'swing',
						step: function (now) {  // now는 step 함수의 인자로, 여기선 noob 숫자를 의미
		...
		<div class='col' id='adminBody'>
			...
			<div class='row'>
				<div class='col mt-2' id='mainUsrJoin'>
					...
					<small>
						<a href='/godgamez/admin/users' class='text-secondary float-right'>
