				...
				<div id='body1' class='collapse' data-parent='#sideMenu'>
					<div class='card-body'>
						<ul class='hyphen text-light'>
							<li>
								<a href='/godgamez/admin/users'>회원</a>
							</li>
							<li>
								<a href='/godgamez/admin/users/mail'>자동 메일</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div>
				...
				<div id='body2' class='collapse' data-parent='#sideMenu'>
					<div class='card-body'>
						<ul class='hyphen text-light'>
							<li>
								<a href='/godgamez/admin/classes'>클래스</a>
							</li>
							<li>
								<a href='/godgamez/admin/quests'>퀘스트</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div>
				...
				<div id='body3' class='collapse' data-parent='#sideMenu'>
					<div class='card-body'>
						<ul class='hyphen text-light'>
							<li>
								<a href='/godgamez/admin/coupons'>쿠폰</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div>
				...
				<div id='body4' class='collapse' data-parent='#sideMenu'>
					<div class='card-body'>
						<ul class='hyphen text-light'>
							<li>
								<a href='/godgamez/admin/logos'>로고</a>
							</li>
							<li>
								<a href='/godgamez/admin/log'>로그</a>
							</li>
						</ul>
					</div>
				</div>
