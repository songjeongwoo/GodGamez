...
<div id='body'>
	...
	<div class='container-fluid'>
		<div class='row' id='godgameGuide'>
			<img src='/godgamez/res/guide/guide_banner.png' alt='배너이미지' id='banner'>
		</div>
	</div>
	<div class='container'>
				...
				<div id='classGuide'>
					<div class='row mt-3 mb-5' id='cards'>
						<div class='col d-flex justify-content-center'>
							<div class='card'>
								<div class='card-body'>
									<img alt='공부도구 이미지' src='/godgamez/res/guide/guide_study.png'>
								</div>
						...
						<div class='col'>
							...
							<div class='row d-flex justify-content-center mt-5'>
								<div class='card mt-5'>
									<div class='card-body'>
										<img alt='운동도구 이미지' src='/godgamez/res/guide/guide_sports.png'>
									</div>
									<div class='card-footer'>
										<div class='row'>
											<div class='col d-flex justify-content-start'>
				...
				<div id='contentsGuide'>
					<div class='row mt-5' id='cards'>
						<div class='col d-flex justify-content-center'>
							<div class='card'>
								<div class='card-body'>
									<img alt='퀘스트 이미지' src='/godgamez/res/guide/guide_quest.png'>
								</div>
						...
						<div class='col'>
							...
							<div class='row d-flex justify-content-center mt-5'>
								<div class='card mt-5'>
									<div class='card-body'>
										<img alt='보상 이미지' src='/godgamez/res/guide/guide_reward.png'>
									</div>
									<div class='card-footer text-center'>
